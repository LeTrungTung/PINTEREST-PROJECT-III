...
router.get('/count-user-followed', FollowUserController.handleCountUserFollowed);
router.get('/count-followed-other', FollowUserController.handleCountFollowOtherUser);
router.get('/', (req, res) => {
  res.json('Follows Ok');
});
